    ...
    res.send(`
        ...
        <head>
            ...
            <style>
                ...
                .user-status { display: flex; align-items: center; font-size: 22px; font-weight: bold; color: #5b86e5; margin-bottom: 25px; }
                .online-dot { width: 14px; height: 14px; background-color: #00e676; border-radius: 50%; margin-right: 12px; box-shadow: 0 0 10px #00e676; }
                .stat-row { display: flex; justify-content: space-between; align-items: center; margin-bottom: 18px; font-size: 16px; }
                .stat-label { color: #a0a5b5; }
                ...
                .footer-text { text-align: right; font-size: 11px; color: #4f5366; margin-top: 25px; border-top: 1px solid #1f2336; padding-top: 10px; }
            </style>
            <script>
                setInterval(async () => {
                    try {
        ...
        <body>
            <div class="dashboard-box">
                <div class="user-status"><div class="online-dot"></div><span id="username">กำลังโหลดข้อมูล...</span></div>
                <div class="stat-row"><div class="stat-label">💰 เงินในตัว:</div><div id="cash" class="stat-value cash-style">กำลังรอ...</div></div>
                <div class="stat-row"><div class="stat-label">🚗 ขายรถแล้ว:</div><div id="carsSold" class="stat-value car-style">กำลังรอ...</div></div>
                <div class="stat-row"><div class="stat-label">🏠 ระยะทางขับ:</div><div id="kms" class="stat-value km-style">กำลังรอ...</div></div>
                <div class="footer-text">อัปเดตล่าสุด: <span id="timestamp">--:--:--</span></div>
            </div>
        </body>
        </html>
    `);
